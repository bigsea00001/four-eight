...
// 페이지마다 <script src="posthog.js" defer> 로 부른다 — index.html · 2027.html · privacy · terms · refund.
//
// 🔴 유럽 방문자 동의 창은 «없다». hill·eet 은 Vercel 이 붙이는 국가 헤더(x-vercel-ip-country)로
//    유럽 방문자를 가리는데, fe.eet.kr 은 nginx(14.39)라 그 헤더가 없다. 국가를 알 방법을 정하기 전에는 붙이지 않는다.
//
...
//    개인정보처리방침(privacy.html 1항 바)은 아직 「외부 분석 도구를 쓰지 않는다」고 적고 있다 — 고치기 전에는 배포하지 않는다.
...
(function () {
    ...
    posthog.init('phc_pB3UZxBy5FJsmrKjeGH6AeDjNfesQgJFS35gVeSZk7MH', {
